...
(function () {
    ...
    const GAME1_DATA = [
        {
            ...
            cards: [
                ...
                { 
                    id: "c5", 
                    name: "Asap Aroma", 
                    img: "assets/images/lokaplay/card_asap_aroma.png", 
                    target: "gas",
        ...
        },
        {
            ...
            cards: [
                { 
                    ...
                    img: "assets/images/lokaplay/card_penguapan_garam.png", 
                    target: "memerlukan",
                ...
                { 
                    ...
                    img: "assets/images/lokaplay/card_pengembunan_arak.png", 
                    target: "melepaskan",
    ...
    class LokaPlayController {
                            ...
                            ${qData.cards.map(card => `
                                <div class="g1-card" id="card-${card.id}" data-card-id="${card.id}" data-target="${card.target}">
                                    <div class="g1-card-img-box">
                                        <img src="${card.img.startsWith('assets/') ? card.img : `assets/images/lokaplay/${card.img}`}" alt="${card.name}" 
                                             onerror="this.src='${card.img.startsWith('assets/') ? card.img.replace(/^assets\/images\//, 'image/') : `image/lokaplay/${card.img}`}'" />
                                    </div>
        ...
        showGame1CardFeedbackModal(cardData, isLastCard, matchedDz) {
            ...
            if (imgEl) {
                const imgSrc = cardData.img.startsWith('assets/') ? cardData.img : `assets/images/lokaplay/${cardData.img}`;
                const fallbackSrc = cardData.img.startsWith('assets/') ? cardData.img.replace(/^assets\/images\//, 'image/') : `image/lokaplay/${cardData.img}`;
                imgEl.src = imgSrc;
                imgEl.onerror = () => {
