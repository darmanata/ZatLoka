 ...
 * Game 2: Detektif Kalor (Drag the Words)
...
(function () {
    ...
    const GAME1_DATA = [
        ...
        {
            id: 2,
            title: "Soal 2: Perubahan Wujud & Kalor",
            ...
            dropZones: [
                { id: "memerlukan", label: "Memerlukan Kalor", color: "#f97316", bg: "rgba(249, 115, 22, 0.1)" },
                { id: "melepaskan", label: "Melepaskan Kalor", color: "#06b6d4", bg: "rgba(6, 182, 212, 0.1)" }
            ],
            cards: [
    ...
    // --- 3. DATA GAME 2: DETEKTIF KALOR (DRAG THE WORDS) ---
    const GAME2_DATA = [
        {
            id: 1,
        ...
        },
        {
            ...
            text: "Dalam pembuatan Arak Bali, uap alkohol hasil pemanasan mengalami perubahan wujud menjadi tetesan cair yang disebut {0}. Perubahan dari fase gas ke cair ini terjadi karena uap alkohol {1} energi panas (kalor) saat melewati pipa pendingin.",
        ...
        },
        {
            ...
            text: "Ketika es batu dipanaskan hingga meleleh, partikel air akan {0} kalor dari lingkungan. Penambahan energi ini menyebabkan energi kinetik partikel {1} sehingga pergerakan partikel semakin cepat...",
    ...
    const GAME3_DATA = [
        ...
        },
        {
            ...
            correct: 1, // B
            explanation: "Perubahan wujud dari gas (uap arak) menjadi cair (tetesan arak) disebut mengembun/kondensasi. Proses ini terjadi karena uap melepaskan energi panas (kalor) ke lingkungan pendingin."
        },
        {
            id: 4,
            ...
            correct: 2, // C
            explanation: "Saat meleleh/mencair, zat menyerap kalor. Kalor ini meningkatkan energi kinetik partikel sehingga pergerakannya lebih cepat dan mampu mengatasi gaya tarik antarpartikel yang tadinya kaku."
        },
        {
            id: 5,
                ...
                <main class="lokaplay-hub-content">
                    <div class="hub-welcome-banner">
                        <div class="hub-banner-text">
                            ...
                            <p>Uji pemahaman wujud zat, kalor, dan perubahan materi melalui 3 permainan interaktif yang menyenangkan.</p>
                        </div>
                    </div>
                ...
                <main class="g1-victory-screen">
                    <div class="victory-card">
                        ...
                        <div class="victory-actions">
                            ...
                            <button class="btn btn-primary" id="btn-g1-to-g2">Lanjut Game 2 (Detektif Kalor) ▶</button>
                        </div>
                    </div>
                </main>
            `;
            ...
            this.container.innerHTML = `
                <header class="lokaplay-header">
                    <div class="header-left">
                        ...
                        <div class="lokaplay-title-wrapper">
                            <span class="lokaplay-badge">GAME 2 • DETEKTIF KALOR</span>
                            <h2>${qData.title}</h2>
                        </div>
                    </div>
                    <div class="header-right">
        ...
        renderGame2Victory() {
            ...
            this.container.innerHTML = `
                <header class="lokaplay-header">
                    ...
                    <h2>Detektif Kalor Selesai!</h2>
                </header>
                <main class="g2-victory-screen">
                    <div class="victory-card">
                        <div class="victory-icon">🔥</div>
                        <h3>Luar Biasa, Detektif Kalor!</h3>
                        <p>Kamu telah sukses meneliti seluruh 8 fenomena kalor dan perubahan materi pada tradisi Bali!</p>
                        <div class="victory-stats">
                            <div class="vstat-item">
