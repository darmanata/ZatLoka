        ...
        2: {
            ...
            pg: [
                {
                    ...
                    options: [
                        { text: "Kalor diserap digunakan untuk menaikkan kecepatan gerak partikel secara cepat.", correct: false },
                        { text: "Kalor yang diserap digunakan sepenuhnya untuk memutuskan atau merenggangkan ikatan antarpartikel saat mengalami perubahan wujud.", correct: true },
                        { text: "Partikel zat berhenti bergerak sama sekali saat mencapai titik suhu kritis tersebut.", correct: false },
                        { text: "Massa zat mengalami penyusutan sehingga energi kalor terbuang ke lingkungan.", correct: false }
                    ]
                },
                {
                    id: "2.2",
                    ...
                    options: [
                        ...
                        { text: "Penguapan melepaskan kalor ke lingkungan, sedangkan mendidih menyerap seluruh kalor wadah.", correct: false }
                    ]
                },
                {
                    id: "2.3",
                ...
                },
                {
                    ...
                    question: "Analisis jarak antarpartikel dan kebutuhan kalor pada peristiwa kapur barus (menyublim)...",
                    options: [
                        { text: "Melepaskan kalor, jarak berubah sangat rapat.", correct: false },
                        { text: "Menyerap kalor, jarak partikel berubah langsung dari sangat rapat (padat) menjadi sangat berjauhan (gas) tanpa melalui fase cair.", correct: true },
                        { text: "Melepaskan kalor, jarak berubah dari cair ke padat.", correct: false },
                        { text: "Menyerap kalor, ukuran molekul menyusut.", correct: false }
                    ]
                },
                {
                    id: "2.5",
                    ...
                    options: [
                        ...
                        { text: "Karena titik leleh memerlukan energi kalor lebih besar dari kalor penguapan.", correct: false },
                        { text: "Karena pemutusan ikatan total dari fase cair menjadi gas memerlukan energi kalor yang jauh lebih besar daripada sekadar merenggangkan ikatan padat ke cair.", correct: true },
            ...
            essay: [
                ...
                },
                {
                    id: "e2.3",
                    num: 3,
                    question: "Mengapa luka melepuh akibat terkena uap air mendidih (100°C) terasa jauh lebih parah dibandingkan air panas biasa dengan suhu yang sama? Hubungkan jawabanmu dengan proses pelepasan kalor (kalor laten penguapan)!"
                }
            ]
        },
            ...
            pg: [
                {
                    ...
                    options: [
                        ...
                        { text: "Pembakaran menyerap kalor sedangkan penguapan aroma melepaskan kalor.", correct: false },
        ...
        devUnlockAll() {
            const data = {
                ...
                essays: {
                    ...
                    "2": ["Air laut sulit menguap tanpa adanya transfer energi kalor dari sinar matahari.", "Tekanan udara di gunung lebih rendah sehingga partikel lebih mudah lepas menjadi uap.", "Uap air menyimpan kalor laten penguapan yang dilepas seketika saat menyentuh kulit."],
    ...
    class KuisController {
        ...
        renderKuisArena(qData) {
                ...
                <div class="kuis-screen-wrapper">
                    ...
                    <main class="kuis-arena-content">
                        ...
                        <div class="kuis-inst-banner">
                            ...
                            <div class="inst-text">
                                <strong>Petunjuk:</strong> Jawab 5 soal Pilihan Ganda & 3 soal Esai di bawah. 
                                Jawaban esai wajib berisi minimal 3 kata agar tombol kirim dapat diaktifkan.
                            </div>
                        </div>
                        ...
                        <div class="kuis-section-title" style="margin-top: 2rem;">
                            ...
                            <span class="kuis-req-note">Murni Analisis Teks (Minimal 3 Kata per Soal)</span>
                        </div>
                                ...
                                <div class="kuis-essay-card" id="ecard-${e.id}">
                                    ...
                                    <div class="ecard-input-wrapper">
                                        <textarea class="ecard-textarea" data-eid="${e.id}" 
                                                  placeholder="Tuliskan argumen dan penjelasan ilmiahmu di sini... (minimal 3 kata)"></textarea>
                                        <div class="ecard-counter" id="counter-${e.id}">
                                            0 kata <span class="counter-warning">(kurang dari 3 kata)</span>
                                        </div>
                                    </div>
                                </div>
                            `).join('')}
            ...
            this.container.querySelectorAll('.ecard-textarea').forEach(textarea => {
                textarea.addEventListener('input', () => {
                    ...
                    const words = val.length > 0 ? val.split(/\s+/).filter(w => w.length > 0) : [];
                    const wordCount = words.length;

                    const counterEl = document.getElementById(`counter-${eId}`);
                    if (counterEl) {
                        if (wordCount >= 3) {
                            counterEl.innerHTML = `<span class="counter-valid">✓ ${wordCount} kata (memenuhi syarat)</span>`;
                        } else {
                            counterEl.innerHTML = `${wordCount} kata <span class="counter-warning">(minimal 3 kata)</span>`;
                        }
                    }
        ...
        handleSubmitKuis(qData) {
            ...
            for (let i = 0; i < qData.essay.length; i++) {
                ...
                if (wordCount < 3) {
                    KuisSound.play('wrong');
                    alert(`Soal Esai #${e.num} belum memenuhi syarat (minimal 3 kata). Silakan lengkapi terlebih dahulu.`);
