...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 8. LEVEL 2.1: ES DALUMAN (STATE SWAPPING)
    const dalumanImg = document.getElementById('daluman-img');
    ...
    if (btnPanasDaluman && btnBekuDaluman) {
        btnPanasDaluman.addEventListener('click', () => {
            if (dalumanImg) dalumanImg.src = 'assets/images/level2/daluman-cair.png';
            dalumanTextDesc.innerHTML = '<strong>Meleleh (Mencair)</strong> adalah perubahan wujud dari padat menjadi cair akibat <strong>MENYERAP KALOR</strong>. Energi panas membuat energi kinetik partikel meningkat sehingga ikatan antarpartikel yang kaku menjadi merenggang.';
            showMascotBubble("Daluman mencair saat menyerap energi panas!");
        });

        btnBekuDaluman.addEventListener('click', () => {
            if (dalumanImg) dalumanImg.src = 'assets/images/level2/es-daluman-padat.png';
            dalumanTextDesc.innerHTML = '<strong>Membeku</strong> adalah perubahan wujud dari cair menjadi padat akibat <strong>MELEPASKAN KALOR</strong>. Penurunan suhu membuat pergerakan partikel melambat sehingga gaya tarik antarpartikel kembali mengikatnya secara kaku dan teratur.';
            showMascotBubble("Daluman kembali membeku saat suhu diturunkan!");
        });
    }
    ...
    if (btnDidihL22 && btnDinginL22) {
        btnDidihL22.addEventListener('click', () => {
            if (evapUapL22) {
                evapUapL22.style.opacity = '0.85';
            }
            if (evapTetesanL22) {
                evapTetesanL22.style.opacity = '0';
            }
            evapTextL22.innerHTML = '<strong>Menguap</strong> adalah perubahan wujud dari cair menjadi gas akibat <strong>MENYERAP KALOR</strong>. Partikel menyerap energi panas hingga pergerakannya sangat cepat dan memutus ikatan antarpartikel cair.';
            showMascotBubble("Cairan arak di panci menyerap panas dan menguap!");
        });

        btnDinginL22.addEventListener('click', () => {
            if (evapTetesanL22) {
                evapTetesanL22.style.opacity = '1';
            }
            if (evapUapL22) {
                evapUapL22.style.opacity = '0';
            }
            evapTextL22.innerHTML = '<strong>Mengembun</strong> adalah perubahan wujud dari gas menjadi cair akibat <strong>MELEPASKAN KALOR</strong>. Pelepasan energi panas membuat gerak acak partikel gas melambat dan merapat kembali.';
    ...
    if (btnPanasBarus) {
        btnPanasBarus.addEventListener('click', () => {
            ...
            sublimTextDesc.innerHTML = '<strong>Menyublim</strong> adalah perubahan wujud dari padat menjadi gas akibat <strong>MENYERAP KALOR</strong>. Partikel padat langsung melepaskan diri menjadi pergerakan bebas gas tanpa mencair terlebih dahulu.';
    ...
    if (saltSunSlider) {
        saltSunSlider.addEventListener('input', (e) => {
            ...
            if (val === 100) {
                saltTextDesc.innerHTML = '<strong>Mengkristal (Mendeposisi)</strong> adalah perubahan wujud dari gas menjadi padat akibat <strong>MELEPASKAN KALOR</strong>. Partikel gas melepaskan energi panas dan merapat kaku menjadi kristal padat.';
    ...
    if (tempSlider) {
        tempSlider.addEventListener('input', (e) => {
            ...
            if (val === 0) {
                tempTextDesc.innerHTML = '<strong>Titik Leleh</strong> adalah suhu konstan saat suatu zat padat berubah wujud menjadi cair (misal: es batu mencair pada suhu 0°C). Selama proses mencair terjadi, suhu zat akan tetap stabil meskipun terus dipanaskan karena energi kalor digunakan untuk merenggangkan ikatan partikel.';
                showMascotBubble("Suhu 0°C! Ini adalah Titik Leleh air!");
            } else if (val === 100) {
                tempTextDesc.innerHTML = '<strong>Titik Didih</strong> adalah suhu konstan saat suatu zat cair mendidih dan berubah wujud menjadi gas secara menyeluruh (misal: air murni mendidih pada suhu 100°C pada tekanan 1 atm).';
    ...
    // 14. SLIDE 9 ACTION BUTTONS & RESET ENGINE
    ...
    if (btnFinalHome) {
        btnFinalHome.addEventListener('click', () => {
            materiScreen.classList.remove('active');
